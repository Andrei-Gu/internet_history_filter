import unittest
from ..main import is_interesting_dct


class TestIsInterestingDct(unittest.TestCase):
    def setUp(self):
        self.rows = ({"@timestamp": "Mar 30, 2023 @ 15:55:22.000",
                      "src_ip": "10.1.1.1",
                      "realm": "SomeRealm",
                      "auth_user": "aspushkin",
                      "response_code": "200",
                     ...
                     {"@timestamp": "Mar 30, 2023 @ 15:50:22.000",
                      "src_ip": "10.1.1.1",
                      "realm": "SomeRealm",
                      "auth_user": "aspushkin",
                      "response_code": "200",
        ...
        self.filtration_keys = {'[not_interesting_parts]': ['arbitr.ru', '.gov.ru', 'alta.ru', 'metrika.kontur'],
                                ...
                                '[interesting_parts]': ['nalog.ru', 'yandex.ru/search', '.gosuslugi.ru'],
                                '[interesting_tails]': ['.zip','.7z', ':443', ':8080'],
                                }
    ...
    def test_url_contains_part(self):
        self.assertTrue(is_interesting_dct(self.rows[0], self.filtration_keys, self.headers))

    def test_url_ends_with_tail(self):
        self.assertTrue(is_interesting_dct(self.rows[1], self.filtration_keys, self.headers))

    def test_url_doesnt_contain_part(self):
        self.assertFalse(is_interesting_dct(self.rows[2], self.filtration_keys, self.headers))
